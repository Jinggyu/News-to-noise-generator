...
This is a real-time implementation simply captures web contents (New York times articles), transfers them to speech voice, and composing the generated speech to noise-like/textural sound. The generated speech are real-timely layered in orders (according to its posting time) and dissolved until the sound lost it's semantics. 
